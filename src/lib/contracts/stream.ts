...
import { StateSnapshotResponseSchema } from "./state";

const DeltaItemSchema = z.record(z.string(), z.unknown());
...
export type StateStreamEvent =
  | { type: "ready"; payload: StateStreamReadyPayload }
  | { type: "snapshot"; payload: StateStreamSnapshotPayload }
  | { type: "delta"; payload: StateStreamDeltaPayload }
  | { type: "tick"; payload: StateStreamTickPayload };
