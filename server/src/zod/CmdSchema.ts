...
export const StartFortifyBuildingArgsSchema = z.object({
  buildingId: z.string().min(1),
});

export const CancelFortifyBuildingArgsSchema = z.object({
  buildingId: z.string().min(1),
});

export const FinishFortifyNowArgsSchema = z.object({
  buildingId: z.string().min(1),
});
